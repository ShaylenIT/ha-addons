...
> Requires Python 3.11+ and Home Assistant development dependencies.
...
```powershell
python -m pytest -q tests/test_purge.py tests/test_services.py tests/test_coordinator.py
```
